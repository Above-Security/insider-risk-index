...
export const ASSESSMENT_QUESTIONS: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 25, label: "Basic log aggregation", description: "Some logs centralized but no correlation or 24/7 monitoring" },
      { value: 50, label: "SIEM with correlation", description: "SIEM deployed with basic log correlation (may have too many logs, limited monitoring coverage)" },
      { value: 75, label: "Managed SIEM/MSSP", description: "24/7 monitoring with managed service provider or dedicated SOC team" },
      { value: 100, label: "AI-powered security fabric", description: "Fully aggregated security data fabric with AI-supported analysis and automated response" },
    ],
    weight: 0.25,
  ...
  },
  {
    ...
    options: [
      ...
      { value: 100, label: "Risk-based intelligent reviews", description: "Risk-based reviews informed by real-time intelligence and analytics" },
    ],
    weight: 0.2,
  ...
  // PHISHING RESILIENCE PILLAR
  {
    ...
    options: [
      ...
      { value: 100, label: "Advanced behavioral analysis", description: "AI-powered behavioral analysis with automated response and remediation" },
    ],
    weight: 0.3,
  ...
  },
  {
    ...
    options: [
      ...
      { value: 100, label: "Human risk intelligence program", description: "Real-time human risk management with personalized coaching and behavioral intelligence" },
    ],
    weight: 0.25,
